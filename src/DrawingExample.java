...
public class DrawingExample extends JComponent {
    ...
    public void paintComponent(Graphics g) {
        ...
        //draws a rectangle outline at (400,300) that is 100 wide, 50 tall
        g.drawRect(400, 300,100,50);
        //change the color of rectangle
        g.setColor(Color.BLUE);
        //draws a coloured rectangle at (500,300) that is 100 wide, 50 tall
        g.fillRect(500,400,100,50);
        //set color for oval
        g.setColor(Color.PINK);
        //draws oval inside of rectangle
        ...
        //xpositions,yposition,how many points all together
